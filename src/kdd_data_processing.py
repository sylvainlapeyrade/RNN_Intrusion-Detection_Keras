...
def kdd_processing(params):
    ...
    np.save(data_path + 'kdd_x_train', x_train)
    np.save(data_path+'kdd_y_train', y_train)
    np.save(data_path + 'kdd_x_test', x_test)
    np.save(data_path+'kdd_y_test', y_test)
